...
class PeselRule(BaseRule):
    ...
    def __init__(self):
        super().__init__(regex=PeselRule.REGEX, placeholder=PeselRule._ANONYMIZATION_TAG_PLACEHOLDER)
    ...
    def apply(self, text: str) -> str:
        ...
        def replacer(match: re.Match) -> str:
            pesel = match.group(0)
            return self._ANONYMIZATION_TAG_PLACEHOLDER if is_valid_pesel(pesel) else pesel
