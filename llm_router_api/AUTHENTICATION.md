...
The seed file is a JSON array. Each record must have `key_plain` and optionally the following fields (matching the
`ApiKeyRecord` dataclass):

| Field             | Type    | Description                                                         |
|-------------------|---------|---------------------------------------------------------------------|
| `key_id`          | `str`   | Unique identifier for this key                                      |
| `key_plain`       | `str`   | The plaintext API key (generated by CLI or provided manually)       |
| `key_prefix`      | `str`   | First 7 characters of the plaintext key (auto-generated if omitted) |
