...
DEFAULT_ENV: Dict[str, str] = {
    ...
    # Worker slots (first_available_optim_nworkers)
    "LLM_ROUTER_LB_SLOT_LEASE_SECONDS": "120",
    "LLM_ROUTER_LB_SLOT_MAX_AGE_SECONDS": "1800",
    "LLM_ROUTER_LB_HOST_PIN_TTL_SECONDS": "3600",
    # Monitoring
